...
Sou desenvolvedor em formação e atualmente atuo como estagiário na área de tecnologia, onde venho aplicando na prática conhecimentos em desenvolvimento web.

Tenho experiência na construção de aplicações fullstack, trabalhando com Node.js no back-end e Vue.js no front-end, além de integração com banco de dados utilizando Supabase e SQLite. Gosto de entender como as coisas funcionam por trás, não apenas fazer funcionar.

Tenho interesse em criar sistemas completos, desde a interface até a lógica de negócio e persistência de dados. Estou sempre buscando evoluir tecnicamente, melhorar a qualidade do meu código e aprender novas ferramentas que agreguem valor aos meus projetos.
